...
$this->title = 'Коэффициент студента';
...
<div class="row">
  <div class="col-lg-3">
    <ul class="nav nav-pills nav-stacked" style="width: 200px;">
        ...
        <li class="active"><a href=<?=$education?>>Коэффициент студента</a></li>
        <li><a href=<?=$activity?>>Направления деятельности</a></li>
      </ul>
  </div>
  <div class="col-lg-6">
    <h4>Критерий <b><?= $this->title ?></b> применяется при оценивании студента</h4>
