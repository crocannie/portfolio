...
--
-- Хост: localhost:8889
-- Время создания: Май 18 2016 г., 20:01
...
INSERT INTO `date` (`id`, `from`, `to`, `idFacultet`) VALUES
(2, '2016-05-25', '2016-06-01', 1);
...
INSERT INTO `facultet` (`id`, `name`, `dekan`, `idUniversity`) VALUES
(1, 'математики и информационных технологий', 'Жолобов Д.А.', 1),
