...
--
-- Host: localhost
-- Generation Time: Mar 31, 2016 at 11:32 PM
...
INSERT INTO `achievements` (`id`, `name`, `idStudent`, `dateEvent`, `idEventType`, `idStatus`, `eventTitle`, `idDocumentType`, `idDocument`, `location`) VALUES
(97, 'ddss', 50, '2016-03-04', 2, 2, 'ff', 1, NULL, 'uploads/50/(lCq).png'),
(100, 'ddd', 50, '2016-03-03', 1, 1, 'dd', 1, NULL, 'uploads/50/(A1q).png'),
(104, 'вкпкппк', 50, '2016-03-03', 1, 1, 'кпкп', 1, NULL, 'uploads/50/a41a450b-6d6f-413d-a41b-68cc0bbc3f4a(0W5).jpg'),
(106, 'вмсвимипи', 50, '2016-03-25', 2, 1, 'ввсв', 2, NULL, 'uploads/50/a41a450b-6d6f-413d-a41b-68cc0bbc3f4a(UVK).jpg'),
(107, 'qwas', 48, '2016-03-01', 2, 1, 'aaas', 1, NULL, 'uploads/48/карточкаучастникаконференции(aFg).doc');
...
CREATE TABLE IF NOT EXISTS `ratingCulture` (
  ...
  PRIMARY KEY (`id`),
  KEY `ratingCulture_ibfk_1` (`idStudent`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `ratingSport` (
  ...
  `mark` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `ratingSport_ibfk_1` (`idStudent`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;
...
(46, 'Иванов', '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(47, 'Иванов', 'София', 'Ивановdfdf', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(48, 'Иванов', 'София', 'Ивановна', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(49, 'Иванов', 'Маргарита', 'Иванов', 1, 1, 1, NULL, NULL, 1, 2),
(50, 'Васильева', 'Маргарита', 'Ивановвава', 1, 1, 1, 0, NULL, 1, 2);
...
(46, 'a4@gmail.com', '$2y$13$pDQoJVPNHtStYeoaj29DpOVCjyUypg15LOUx.R3ud3/YuSI5FmXhO', 20, '', NULL, 10, 0, 0),
(47, 'a1@gmail.com', '$2y$13$QPQVH9jiM3XeNJoArhIwbuHEKq5KQX0i8tw6qPZFKcUeZsEWpFg7a', 10, '', NULL, 10, 0, 0),
(48, 'a781@gmail.com', '$2y$13$HRqXBDrJNXULUrr11uFxS./S0zZ2/gw0NizIMMDsLseKcEmppGE5O', 10, '', NULL, 10, 0, 0),
(49, 'a221@gmail.com', '$2y$13$MBTJ9oWLmH8ak/hUOQ1LFuxH62yj.eABcUbpSM7OkXEFWLQP35F2i', 10, '', NULL, 10, 0, 0),
(50, 'a1440@gmail.com', '$2y$13$bM3JzRPrVtIJRaVuQGAzBuQPGtYlYtDm/7iUYs8FKu8mWvFOnyHl6', 15, '', NULL, 10, 0, 0),
(51, 'a1www@gmail.com', '$2y$13$vZWBnJ.uwLAvP6pJfZgil.PnWcceFVVgdsrkUJT37.rHSrO22QiaO', 10, '', NULL, 10, 0, 0);
...
ALTER TABLE `achievements`
  ...
  ADD CONSTRAINT `achievements_ibfk_5` FOREIGN KEY (`idDocument`) REFERENCES `documents` (`id`) ON UPDATE CASCADE;
...
ALTER TABLE `ratingCulture`
  ADD CONSTRAINT `ratingCulture_ibfk_1` FOREIGN KEY (`idStudent`) REFERENCES `students` (`idStudent`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `ratingScience`
--
ALTER TABLE `ratingScience`
  ADD CONSTRAINT `ratingScience_ibfk_1` FOREIGN KEY (`idStudent`) REFERENCES `students1` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `ratingSocial`
--
ALTER TABLE `ratingSocial`
  ADD CONSTRAINT `ratingSocial_ibfk_1` FOREIGN KEY (`idStudent`) REFERENCES `students` (`idStudent`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `ratingSport`
--
ALTER TABLE `ratingSport`
  ADD CONSTRAINT `ratingSport_ibfk_1` FOREIGN KEY (`idStudent`) REFERENCES `students1` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `ratingStudy`
--
ALTER TABLE `ratingStudy`
  ADD CONSTRAINT `ratingStudy_ibfk_1` FOREIGN KEY (`idStudent`) REFERENCES `students` (`idStudent`) ON DELETE CASCADE ON UPDATE CASCADE;
